...
public class OthelloState implements State {
	...
	/** {@inheritDoc} */
	//应该错了，原heuristic面向一个电脑
	@Override
	public int compareTo(State state) {
		//float heuristic = this.heuristic() - state.heuristic();
		float heuristic = this.heuristic(true) - state.heuristic(true);
	...
	public float heuristic(boolean choice){
		return choice==false? -heuristic(): heuristic1();
	}
	...
	public float heuristic() {
		...
		return this.param[0] * this.pieceDifferential() +this.param[1] * this.moveDifferential() +this.param[2] * this.cornerDifferential() +this.param[3] * this.stabilityDifferential() + winconstant;
	}
	...
	public float heuristic1() {
		...
		return param[4]*this.pieceDifferential() +
		   param[5] * this.moveDifferential() +
		  param[6] * this.cornerDifferential() +
		   param[7] * this.stabilityDifferential() + 
		   winconstant;
	}
